...
# data.append(Data([], [2.7], "Smurf"))
# data.append(Data([], [2.52], "Smurf"))
# data.append(Data([], [2.57], "Smurf"))
# data.append(Data([], [2.22], "Smurf"))
# data.append(Data([], [3.18], "Troll"))
# data.append(Data([], [3.58], "Troll"))
# data.append(Data([], [3.16], "Troll"))

# print(decision(data, [], [2]))
#data = []
